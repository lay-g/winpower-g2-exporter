...
- [ ] **6.2 与 energy 模块集成**
  - 修改 energy 模块以使用 storage 模块
  - 更新 energy 模块的构造函数接收 storage.StorageManager
  - 更新 energy 模块的配置加载以支持依赖加载顺序
  - 更新 energy 模块的测试使用 Mock StorageManager
  - 验证集成后的功能正确性
...
5. **energy** - 能耗模块 (依赖config, logging, storage)
